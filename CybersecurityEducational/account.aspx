...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card border-success mb-4">
                                        ...
                                        <div class="card-body">
                                            <div id="secureRegistrationForm" class="needs-validation" novalidate>
                                                <asp:Panel ID="RegistrationPanel" runat="server">
                                                    <div class="mb-3">
                                                        <label for="regUsername" class="form-label">Username</label>
                                                        <asp:TextBox ID="regUsername" runat="server" CssClass="form-control" minlength="5" maxlength="20" pattern="[a-z]+" />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <asp:TextBox ID="regEmail" runat="server" CssClass="form-control" TextMode="Email" />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <asp:TextBox ID="regPassword" runat="server" CssClass="form-control" TextMode="Password" minlength="8" pattern="[a-zA-Z0-9]+" />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <asp:TextBox ID="regConfirmPassword" runat="server" CssClass="form-control" TextMode="Password" />
                                                    ...
                                                    <asp:Label ID="RegisterMessage" runat="server" CssClass="text-danger mt-2 d-block" Visible="false" />
                                                </asp:Panel>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card border-primary mb-4">
                                        ...
                                        <div class="card-body">
                                            <div id="secureLoginForm" class="needs-validation" novalidate>
                                                <asp:Panel ID="LoginPanel" runat="server">
                                                    <div class="mb-3">
                                                        <label for="loginEmail" class="form-label">Email</label>
                                                        <asp:TextBox ID="loginEmail" runat="server" CssClass="form-control" TextMode="Email" />
                                                    ...
                                                    <asp:Label ID="LoginMessage" runat="server" CssClass="text-danger mt-2 d-block" Visible="false" />
                                                </asp:Panel>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-primary mb-4">
                                        ...
                                        <div class="card-body">
                                            <div id="twoFactorDemo">
                                                ...
                                                <div id="twoFactorForm" class="needs-validation" novalidate>
                                                    <div class="mb-4">
                                                        <label for="verificationCode" class="form-label">Verification Code</label>
                                                        <input type="text" class="form-control form-control-lg text-center" id="verificationCode" maxlength="6" pattern="[0-9]{6}">
                                            ...
                                            <div id="paymentForm" class="needs-validation" novalidate>
                                                <asp:Panel ID="PaymentPanel" runat="server">
                                                    <div class="mb-3">
                                                        ...
                                                        <asp:TextBox ID="cardName" runat="server" CssClass="form-control" placeholder="John Doe" />
                                                        <div class="invalid-feedback">Cardholder name is required.</div>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="cardNumber" class="form-label">Card Number</label>
                                                        <asp:TextBox ID="cardNumber" runat="server" CssClass="form-control" placeholder="1234 5678 9012 3456" MaxLength="16" pattern="[0-9]{16}" />
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            ...
                                                            <asp:TextBox ID="expiryMonth" runat="server" CssClass="form-control" placeholder="MM" MaxLength="2" pattern="(0[1-9]|1[0-2])" />
                                                            <div class="invalid-feedback">Enter a valid month (01-12).</div>
                                                        </div>
                                                        <div class="col-6">
                                                            <label for="expiryYear" class="form-label">Expiry Year</label>
                                                            <asp:TextBox ID="expiryYear" runat="server" CssClass="form-control" placeholder="YYYY" MaxLength="4" pattern="[0-9]{4}" />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <asp:TextBox ID="cvv" runat="server" CssClass="form-control" placeholder="123" MaxLength="4" pattern="[0-9]{3,4}" />
                                                    ...
                                                    <asp:Label ID="PaymentMessage" runat="server" CssClass="text-danger mt-2 d-block" Visible="false" />
                                                </asp:Panel>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const passwordInput = document.getElementById('<%= regPassword.ClientID %>');
            ...
            const confirmPassword = document.getElementById('<%= regConfirmPassword.ClientID %>');
            ...
            if (twoFactorForm) {
                twoFactorForm.addEventListener('submit', (event) => {
                    ...
                    if (!twoFactorForm.checkValidity() || !code) {
